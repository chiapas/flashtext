...
class KeywordProcessor(object):
    ...
    def __contains__(self, word, kp_name=None):
        ...
        for char in word:
            if char in current_dict:
                ...
                break
        return kp_name in current_dict and len_covered == len(word)

    def __getitem__(self, word, kp_name=None):
        ...
        for char in word:
            if char in current_dict:
                ...
                break
        if kp_name in current_dict and len_covered == len(word):
            return current_dict[kp_name]

    def __setitem__(self, keyword, clean_name=None, kp_name=None):
        ...
        if keyword and clean_name:
            ...
            if kp_name not in current_dict:
                status = True
                self._terms_in_trie += 1
            current_dict[kp_name] = clean_name
        return status

    def __delitem__(self, keyword, kp_name=None):
        ...
        if keyword:
            ...
            if current_dict and kp_name in current_dict:
    ...
    def add_keyword(self, keyword, clean_name=None, kp_name=None):
        ...
        return self.__setitem__(keyword, clean_name, kp_name=kp_name)

    def remove_keyword(self, keyword, kp_name=None):
        ...
        return self.__delitem__(keyword, kp_name=kp_name)

    def get_keyword(self, word, kp_name=None):
        """if word is present in keyword_trie_dict return the clean name for it.
        ...
        return self.__getitem__(word, kp_name=kp_name)
    ...
    def get_all_keywords(self, term_so_far='', current_dict=None, kp_name=None):
    ...
    def extract_keywords(self, sentence, span_info=False, kp_name=None):
        ...
        while idx < sentence_len:
            ...
            if char not in self.non_word_boundaries:
                ...
                if kp_name in current_dict or char in current_dict:
                    # update longest sequence found
                    sequence_found = None
                    longest_sequence_found = None
                    is_longer_seq_found = False
                    if kp_name in current_dict:
                        sequence_found = current_dict[kp_name]
                        longest_sequence_found = current_dict[kp_name]
                    ...
                    if char in current_dict:
                        ...
                        while idy < sentence_len:
                            ...
                            if inner_char not in self.non_word_boundaries and kp_name in current_dict_continued:
                                # update longest sequence found
                                longest_sequence_found = current_dict_continued[kp_name]
                            ...
                            if kp_name in current_dict_continued:
                                # update longest sequence found
                                longest_sequence_found = current_dict_continued[kp_name]
                                sequence_end_pos = idy
                                is_longer_seq_found = True
    ...
    def replace_keywords(self, sentence, kp_name=None):
        """Searches in the string for all keywords present in corpus.
